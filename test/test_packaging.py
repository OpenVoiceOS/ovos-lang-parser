...
from ovos_lang_parser.version import (VERSION_ALPHA, VERSION_BUILD, VERSION_MAJOR,
                           VERSION_MINOR, __version__)

VERSION_FILE = Path(__file__).parent.parent / "ovos_lang_parser" / "version.py"
...
class TestVersionBlock(unittest.TestCase):
    ...
    def test_installed_metadata_matches_source(self):
        ...
        self.assertEqual(installed_version("ovos-lang-parser"), __version__)
